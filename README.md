...
[![Release](https://img.shields.io/github/v/release/latest-debs/gum-debian)](https://github.com/latest-debs/gum-debian/releases)
[![Build](https://github.com/latest-debs/gum-debian/actions/workflows/release.yml/badge.svg)](../../actions)
...
```sh
sudo apt install ./gum_*.deb
```

## Verify

```sh
apt-cache policy gum
gum --version
```
...
Run the [Build gum for Debian](../../actions) workflow on GitHub with the
